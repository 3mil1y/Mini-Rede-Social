...
--
-- Host: 127.0.0.1
-- Tempo de geração: 12-Dez-2023 às 21:19
...
(1, 'Olá, eu sou o usuário 1 e realizei uma postagem', 6, 1),
(5, 'Postagem teste 1 - usuario2', 0, 2),
(6, 'Postagem teste 2 - usuario2', 0, 2),
(7, 'Postagem teste 3 - usuario2', 0, 2),
(8, 'Postagem teste 1 - Empresa3', 0, 6),
(9, 'Postagem teste 2 - Empresa3', 0, 6),
(10, 'Postagem teste 3 - Empresa3', 0, 6),
(11, 'Postagem teste 4 - Empresa3', 0, 6),
(12, 'Postagem teste 5 - Empresa3', 0, 6);
...
--
ALTER TABLE `comentariospostagem`
  MODIFY `idComentario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT de tabela `perfil`
--
ALTER TABLE `perfil`
  MODIFY `idPerf` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de tabela `postagem`
--
ALTER TABLE `postagem`
  MODIFY `id_postagem` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
